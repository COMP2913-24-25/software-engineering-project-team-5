...
const Listing_item = (props) => {
        ...
        const calculate_time_left = () => {
            ...
            if (difference_time > 0) {
                ...
                const minutes = Math.floor(
                    (difference_time % (1000 * 60 * 60)) / (1000 * 60)
                );
                const seconds = Math.floor(
                    (difference_time % (1000 * 60)) / 1000
                );
    ...
    return (
        ...
        <div className="flex flex-wrap justify-center gap-5 mb-8">
            {[...Array(1)].map((_, index) => (
                <div
                    className="w-[220px] border border-gray-300 rounded-lg overflow-hidden bg-gray-100 transition-transform transform hover:scale-105 cursor-pointer flex flex-col items-center"
                    key={index}
                >
                    ...
                    <div className="p-4 w-full font-sans">
                        <div className="flex justify-between items-center font-bold mb-2">
                            <a
                                href="https://localhost:5000/signup"
                        ...
                        <div
                            className={`flex justify-between items-center text-sm ${
                                new Date(item.Available_until) - new Date() <
                                12 * 60 * 60 * 1000
                                    ? "text-red-600"
                                    : "text-gray-700"
                            }`}
