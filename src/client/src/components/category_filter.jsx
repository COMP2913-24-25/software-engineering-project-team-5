    ...
    useEffect(() => {
        const fetch_filteredlistings = async () => {
            ...
            try {
                ...
                const response = await fetch(`${api_base_url}/api/get_category_filters`, {
                    method: "POST",
                    headers: {
    ...
    return (
        <div className="p-3 m-2 bg-white shadow-lg rounded-lg">
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold text-gray-800" id="category-filter-heading">
                    Category Filter
                </h2>
                <button
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {categories.map((category) => (
                            ...
                            >
                                ...
                                />
                                <div
                                    className="w-4 h-4 border-1 border-gray-400 rounded-md flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600"
                                    role="presentation"
                                >
