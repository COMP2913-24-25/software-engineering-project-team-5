...
const Availability_calendar_view = ({ onSubmit }) => {
    ...
    return (
        <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg" role="region" aria-labelledby="availability-heading">
            <h2 className="text-2xl font-bold mb-6 text-center" id="availability-heading">
