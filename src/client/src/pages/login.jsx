    ...
    return (
        <div className="container">
            ...
            <form onSubmit={handle_submit} className="space-y-4">
                <div>
                    <input className="form-control" type="text" name="email_or_username" placeholder="Email" value={form_data.email_or_username} onChange={handle_change} required/>
                    {errors.email_or_username && errors.email_or_username.map((error) => (
                        <p className="text-red-500 text-sm mt-1">{error}</p>
                    ))}
                </div>

                <div>
                    <input className="form-control" type="password" name="password" placeholder="Password" value={form_data.password} onChange={handle_change} required/>
