...
const EnlargedExpertAuthRequest = () => {
    ...
    const get_listing_information = async () => {
        try {
            const response = await fetch(
                "http://localhost:5000/api/get-single-listing",
                {
                    method: "POST",
                    headers: {
    ...
    const handle_second_opinion = async () => {
        const response = await fetch(
            "http://localhost:5000/api/request-second-opinion",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
        ...
        <div className="pl-[10%] pr-[10%]">
            ...
            <div className="mb-6">
                ...
                <p className="text-lg text-gray-600">
                    Seller Full Name: {item.Seller_username}
                </p>
                <p className="text-lg text-gray-600">
                    Seller Username: {item.Seller_name}
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                    ...
                    <div className="mt-8">
                        ...
                        <div>
                            <h3 className="text-lg font-medium mb-2 mt-">
                                Listing Details
                            </h3>
...
export default EnlargedExpertAuthRequest;
